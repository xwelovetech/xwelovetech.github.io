...
export function About() {
  ...
  return (
    <div className="items-center min-h-screen px-6 mx-auto align-middle mt-36 md:mt-0 md:flex md:max-w-7xl pb-36 md:pb-0">
      <Avatar />
      ...
      >
        ...
        <p>
          Adiós a las interfaces viejas, trabajamos con herramientas modernas
          con las que construimos una experiencia de usuario única.{" "}
        </p>
        ...
        <div className="max-w-6xl p-4 mx-auto bg-secondary/20 rounded-xl">
          {dataAboutSkills[index].skills.map((items, index) => (
            <div
              key={index}
              className="flex justify-center max-w-lg gap-4 mx-auto"
            >
